...
"  call Decho("exe silent r! ".g:zip_unzipcmd." -l -- ".s:Escape(a:zipfile,1))
  exe "keepj sil! r! ".g:zip_unzipcmd." -".g:zip_unzipflag." ".s:Escape(a:zipfile,1)
  if v:shell_error != 0
   redraw!
...
"  call Decho("using temp file<".temp.">")
  let fn   = expand('%:p')
  exe "sil! !".g:zip_unzipcmd." ".g:zip_readflags." ".s:Escape(zipfile,1)." ".s:Escape(fnameescape(fname),1).' > '.temp
